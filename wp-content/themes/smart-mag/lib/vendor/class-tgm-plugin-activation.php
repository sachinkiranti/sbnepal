...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function init() {
			...
			// Load class strings.
			$this->strings = array(
				'page_title'                      => __( 'Install Theme Plugins', 'tgmpa' ),
		...
		public function install_plugins_page() {
			...
			// +EDIT: Table handler. 
			$plugin_table = new Bunyad_Theme_Admin_DashPluginsTable();
			...
			// +EDIT: Add filter to add extra data after plugins table.
			do_action( 'tgmpa_after_install_plugins_page', $this );
		}
		...
		public function notices() {
			...
			foreach ( $this->plugins as $slug => $plugin ) {
				...
				if ( ! $this->is_plugin_installed( $slug ) ) {
					// +EDIT: Only non-optional plugins prompt to be installed.
					if ( current_user_can( 'install_plugins' ) && empty( $plugin['optional'] ) ) {
						$install_link_count++;
					...
					// +EDIT: Only non-optional plugins prompt to be activated.
					if ( empty( $plugin['optional'] ) && ! $this->is_plugin_active( $slug ) && $this->can_plugin_activate( $slug ) ) {
		...
		public function process_bulk_actions() {
			...
			if ( 'tgmpa-bulk-install' === $this->current_action() || 'tgmpa-bulk-update' === $this->current_action() ) {
				...
				echo '<div class="tgmpa">',
					...
					<div class="update-php" style="width: 100%; padding-top: 1px;">';
